...
(check-equal? (run '(boolean? 1)) #f)
(check-equal? (run '(char? 1)) #f)
(check-equal? (run '(integer? 1)) #t)
(check-equal? (run '(integer? #f)) #f)
(check-equal? (run '(char=? #\c #\c)) #t)
(check-equal? (run '(char=? #\c #\f)) #f)
(check-equal? (run '(char=? #\c #f)) 'err)
(check-equal? (run '(boolean=? #\c #f)) 'err)
(check-equal? (run '(boolean=? #t #t)) #t)
(check-equal? (run '(= #t #t)) 'err)
(check-equal? (run '(= 4 5)) #f)
(check-equal? (run '(= 5 5)) #t)
(check-equal? (run '(<= #t #t)) 'err)
(check-equal? (run '(<= 4 5)) #t)
(check-equal? (run '(<= 5 2)) #f)
(check-equal? (run '(< #t #t)) 'err)
(check-equal? (run '(< 4 5)) #t)
(check-equal? (run '(< 5 2)) #f)
